                ...
                @else action="{{ url('admin/add-edit-cms-page/'.$cmspage['id']) }}" @endif method="post">@csrf
                    <div class="card-body">
                      <div class="form-group">
                        <label for="title">Title<span style="color: rgb(196, 19, 19)">*</span></label>
                        <input type="text" class="form-control" id="title" name="title" placeholder="Enter Page Title"
                         ...
                         <div class="form-group">
                          <label for="url">URL<span style="color: rgb(196, 19, 19)">*</span></label>
                      ...
                      <div class="form-group">
                          <label for="description">Description<span style="color: rgb(196, 19, 19)">*</span></label>
                          <textarea class="form-control" rows="3" id="description" name="description" placeholder="Enter Description">
                            @if(!empty($cmspage['description'])) {{ $cmspage['description'] }} @endif</textarea>
                      </div>
                      <div class="form-group">
